            ...
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div className="flex flex-col items-center gap-4 p-6 rounded-lg transition-all duration-300 hover:bg-card hover:shadow-xl">
                        <a href="https://share.google/1DiYzQ8EmrLUqr54W" target="_blank" rel="noopener noreferrer" className="bg-accent/20 text-accent p-4 rounded-full transition-transform duration-300 hover:scale-110">
                    ...
                    <div className="flex flex-col items-center gap-4 p-6 rounded-lg transition-all duration-300 hover:bg-card hover:shadow-xl">
                        <a href="mailto:thearchithanarchitects@gmail.com" className="bg-accent/20 text-accent p-4 rounded-full transition-transform duration-300 hover:scale-110">
                    ...
                    <div className="flex flex-col items-center gap-4 p-6 rounded-lg transition-all duration-300 hover:bg-card hover:shadow-xl">
                         <a href="tel:+918279891368" className="bg-accent/20 text-accent p-4 rounded-full transition-transform duration-300 hover:scale-110">
