    ...
    >
      <defs>
        <linearGradient id="gold-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: "#f0e68c" }} />
          <stop offset="100%" style={{ stopColor: "#b8860b" }} />
        </linearGradient>
        <linearGradient id="blue-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: "#4682b4" }} />
          <stop offset="100%" style={{ stopColor: "#00008b" }} />
        </linearGradient>
      ...
      />
      <circle cx="195" cy="80" r="15" fill="url(#gold-gradient)" />
       <path
